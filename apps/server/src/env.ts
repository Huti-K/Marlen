...
export const env = {
  ...
  // Fallbacks only — credentials saved in the app (Settings → onOffice) take
  // precedence; see onoffice/config.ts. onOffice is not in Pipedream's catalog,
  // so it connects natively with an API user's token + secret.
  onoffice: {
